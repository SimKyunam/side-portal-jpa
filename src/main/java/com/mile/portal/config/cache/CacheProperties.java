...
public class CacheProperties {
    public static final int DEFAULT_EXPIRE_SEC = 60 * 30; // 30 minutes

    public static final String USER = "user";
    public static final int USER_EXPIRE_SEC = 60 * 10; // 10 minutes
    ...
    public static final int CODE_EXPIRE_SEC = 0; // 무제한

    public static final String MENU = "menu";
    public static final int MENU_EXPIRE_SEC = 0; // 무제한
}

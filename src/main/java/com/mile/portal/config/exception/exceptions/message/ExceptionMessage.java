package com.mile.portal.config.exception.exceptions.message;

public class ExceptionMessage {

    public static String EXCEPTION_MESSAGE = "오류가 발생했습니다.";
    public static String BAD_REQUEST_MESSAGE = "잘못된 요청 정보 입니다.";
